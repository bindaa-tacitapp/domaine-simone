  ...
  return (
    <nav className="font-imbue uppercase text-2xl">
      ...
      >
        ...
        <label aria-label={t('menu.toggle')} className="" htmlFor="menu-toggle">
          Menu
        </label>
      </div>
      ...
      <div
        className={cn(
          'not-peer-checked:opacity-0 not-peer-checked:translate-y-[2vh] not-peer-checked:hidden starting:peer-checked:opacity-0 starting:peer-checked:translate-y-[2vh] peer-checked:block peer-checked:opacity-100 peer-checked:translate-y-0 transition-all transition-discrete duration-300 ease-in-out',
